...
8. Launch your data migration tool by opening the dtui application (From Desktop).
...
9. Go to C drive and locate stock folder you will see sample data which we would migrate to azure cosmos<br/>
