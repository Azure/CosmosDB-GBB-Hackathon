...
Click on **Next** until you reach to summary page.<br/>
<img src="images/cosmosdbinfo.jpg"/><br/>
Now, Click on **Create**.<br/>
<img src="images/cosmosdbinfo1.jpg"/><br/>
...
6.  Now go to the Lab details page, which you recieved after launching the lab. Copy the VMs **username** and **password** and paste them into your credentials page. Click on **OK**<br/>
...
9. Go to C drive and locate stock folder you will see sample data which we would migrate to cosmos DB<br/>
...
<img src="images/rg.jpg"/><br/>
17.  Now in the **Resource Groups** blade that appear, select the created resource group for cosmos DB.<br/>
<img src="images/cosmosrg.jpg"/><br/>
18.  Then click on the created **Azure Cosmos DB account**.<br/>
<img src="images/cosmosdb.jpg"/><br/>
...
23.  Then go back to the **Target information** page of the Data migration tool and provide the following details.<br/>
    ...
    <img src="images/Notification.jpg"/><br/>   
       - Collections: Enter the name of the new collection, (i.e, **mynewcollection**).  
        - Partition Key: Enter the name of the new collection, (i.e, **/ticker**).
