...
9. Download the sample data inside the **PowerBI VM** which we would migrate to cosmos DB by clicking [here](https://github.com/Azure/CosmosDB-GBB-Hackathon/tree/master/stocks) (https://bit.ly/2SdZFKv) <br/>
