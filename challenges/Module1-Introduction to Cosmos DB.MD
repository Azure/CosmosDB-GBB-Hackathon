...
8.  You'd have a pre-created windows virtual machine named PowerBI VM for you in your azure lab environment. Please access the virtual machine via remote desktop. DNS Name for the virtual machine is also available on the lab details page. 
9.  **Launch** your **data migration tool** by opening the **dtui** application (From Desktop).<br/>
<img src="images/dtui.jpg"/><br/>   
10.  In the **DocumentDB Data Migration Tool** blade that appear, Click on **Next**.<br/>
<img src="images/mig-toolWelcome.jpg"/><br/>   
11.  In the source information page that appear, select Import from **JSON file(s)** and click on **Add Files**.<br/>
<img src="images/SourceInfo.jpg"/><br/>   
12.  Go to  **C** drive and select the **stocks** folder, click on **stocks.json** to open it.<br/>
<img src="images/importfiles1.jpg"/><br/>  
13.  Then in the **source information** page, click on **Next** and a Target information page will appear.<br/><img src="images/SourceInfoNxt1.jpg"/><br/>
14.  **Launch** a browser and **navigate** to https://portal.azure.com. **Login** with your Microsoft Azure credentials.<br/>
15.  Click on the **Resource Group** icon on the **Menu navigation bar**.<br/>
<img src="images/rg.jpg"/><br/>
16.  Now in the **Resource Groups** blade that appear, select the created resource group for cosmos DB, (i.e, **cosmosdb-rg**).<br/>
<img src="images/cosmosrg.jpg"/><br/>
17.  Then click on the created **Azure Cosmos DB account(i.e,cosmosdb321)**.<br/>
<img src="images/cosmosdb.jpg"/><br/>
18.  In the **Azure Cosmos DB account** blade, Click on **keys** menu under the **setting** tile.<br/>
<img src="images/keys.jpg"/><br/>   
19.  Then **copy** the **Primary Connection String** and paste the connection string in a notepad.<br/>
<img src="images/connString.jpg"/><br/>
20.  Now click on **Overview** menu in the **Azure Cosmos DB account** page and copy the newly created database name, i.e, mynewdb.<br/><img src="images/copyDBname.jpg"/><br/>
21.  Now open the notepad and after the connection string add the text **Database=mynewdb**.<br/>
<img src="images/notepad.jpg"/><br/>   
22.  Then go back to the **Target information** page of the Data migration tool and provide the following details.<br/>
...
23.  Then an **advanced** page will appear, in that click on **Next**.
     <img src="images/advancedPage.jpg"/><br/>
24.  Then a Summary page will appear, in that click on **Import**.
     <img src="images/importtodb.jpg"/><br/>
25.  Now the import will start.It will take a couple of minutes to complete.
